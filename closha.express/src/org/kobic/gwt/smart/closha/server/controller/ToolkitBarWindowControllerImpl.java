...
public class ToolkitBarWindowControllerImpl extends RemoteServiceServlet implements ToolkitBarWindowController {
	...
	public int getCurrentInstancePipelineState(String instanceID) {
		...
		return service.getInstancePipelineState(instanceID);
	}
}
