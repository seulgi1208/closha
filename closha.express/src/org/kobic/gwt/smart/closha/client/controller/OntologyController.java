...
@RemoteServiceRelativePath("OntologyController")
public interface OntologyController extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static OntologyControllerAsync instance;
		public static OntologyControllerAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(OntologyController.class);
			}
			return instance;
		}
	}
