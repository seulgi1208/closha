...
public interface WorkManagementControllerAsync {
	...
	public void pipelineForceStop(String instanceOwner, String instanceID, Map<String, String> config, String instanceName, String ownerEmail, AsyncCallback<Boolean> callback);
}
