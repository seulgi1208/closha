...
@RemoteServiceRelativePath("LocalWorkManagementController")
public interface LocalWorkManagementController extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static LocalWorkManagementControllerAsync instance;
		public static LocalWorkManagementControllerAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(LocalWorkManagementController.class);
			}
			return instance;
		}
	}
