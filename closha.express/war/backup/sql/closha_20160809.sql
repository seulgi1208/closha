...
MySQL - 5.6.23-enterprise-commercial-advanced-log : Database - closha
*********************************************************************
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=euckr COLLATE=euckr_bin;
...
) ENGINE=InnoDB AUTO_INCREMENT=562 DEFAULT CHARSET=euckr COLLATE=euckr_bin;
...
CREATE TABLE `ontology` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=euckr;
...
) ENGINE=InnoDB AUTO_INCREMENT=188 DEFAULT CHARSET=euckr COLLATE=euckr_bin;
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=euckr COLLATE=euckr_bin;
...
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=euckr COLLATE=euckr_bin;
